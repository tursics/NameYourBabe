...
//			http://msdn.microsoft.com/de-DE/library/windows/apps/hh974767.aspx
		...
		txt += '<li data-icon="false"><a href="#pageWebView" data-rel="dialog" data-role="button" data-theme="b" data-inline="true" onClick="onPageImprintHome();return true;">' + _( 'imprintWebHome') + '</a></li>';
		txt += '<li data-icon="false"><a href="#pageWebView" data-rel="dialog" data-role="button" data-theme="b" data-inline="true" onClick="onPageImprintSupport();return true;">' + _( 'imprintWebSupport') + '</a></li>';
		txt += '<li data-icon="false"><a href="#pageCopyright">' + _( 'imprintTitleData') + '</a></li>';
		txt += '</ul><br>';
